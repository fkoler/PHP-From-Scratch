...
<head>
  ...
  <title>Job Listings with Ternary Operator</title>
</head>
...
<body class="bg-black">
  ...
  <div class="container mx-auto p-4 mt-4">
    ...
    <?php foreach ($listings as $index => $job) : ?>
      <div class="md my-4">
        <div class="<?= $index % 2 === 0 ? 'bg-blue-200' : 'bg-red-200' ?> rounded-lg shadow-md">
          <div class="p-4">
            ...
            <ul class="mt-4">
              ...
              <li class="mb-2">
                ...
                <span class="text-xs text-white rounded-full px-2 py-1 ml-2 <?= $job["location"] === 'Toronto' ? 'bg-blue-500' : 'bg-green-500' ?>">
                  <?= $job["location"] === "Toronto" ? "Local" : "Remote" ?>
                </span>
              </li>
