    ...
    <div class="md my-4">
      <div class="rounded-lg shadow-md mb-6">
        <div class="p-4">
          ...
          <p class="text-gray-400 text-lg mt-2 mb-5"><?= $post["body"] ?></p>
          <a href="index.php">Go Back</a>
        </div>
      </div>

      <!-- Edit Button -->
      <a href="edit.php?id=<?= $post['id'] ?>" class="bg-green-500 text-white text-center block px-4 py-2 mb-4 rounded hover:bg-green-600 focus:outline-none w-full">Edit</a>
